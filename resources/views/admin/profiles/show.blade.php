...
@section('content')
    ...
    <div class="profile-wrapper">
        ...
        @endif
        <div class="my-2 brand-text-color-1 "><strong>ID</strong>: {{ $profile->id }}</div>
        <div class="my-2 brand-text-color-1 "><strong>EMAIL</strong>: {{ $user->email }}</div>
        <div class="my-2 brand-text-color-1 "><strong>NOME</strong>: {{ $user->name }}</div>
        <div class="my-2 brand-text-color-1 "><strong>INDIRIZZO</strong>: {{ $user->address }}</div>
        <div class="my-2 brand-text-color-1 "><strong>TELEFONO</strong>: {{ $profile->telephone_number }}</div>
